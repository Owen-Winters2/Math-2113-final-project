...
#Function for printing complex and non-complex numbers
def strC(x):
    s = ""
    if(abs(x.real) > 0.001):
...
#Changing variables based on calculation show in paper
determ = a ** 2 + 4 * b
...
#Setting up array for solving system of equations
